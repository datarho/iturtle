...
# -*- coding: utf-8 -*-
#
# iturtle documentation build configuration file
#
...
latex_documents = [
    (master_doc, 'iturtle.tex', 'iturtle Documentation',
     'Samuel Zhang', 'manual'),
]
